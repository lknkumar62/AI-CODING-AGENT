...
fun SettingsScreen(viewModel: SettingsViewModel) {
    ...
    Column(
        ...
        Text(
            "Create a fine-grained personal access token with Contents read/write on the repos you want VASU to edit. It is stored encrypted and is never sent to the AI provider or logged.",
            style = MaterialTheme.typography.bodyMedium
        )
        OutlinedTextField(
            value = githubToken,
